...
public class RecordActivity extends Activity {
    ...
    public void clickRecord(View view) {
        ...
        if (isRecording) {
            // 設定按鈕圖示為錄音中
            record_button.setImageResource(android.R.drawable.ic_media_pause);
            // 建立錄音物件
        ...
        // 停止錄音
            ...
            // 設定按鈕圖示為停止錄音
            record_button.setImageResource(android.R.drawable.ic_media_play);
            // 麥克風音量歸零
